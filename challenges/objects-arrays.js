...
graduates.forEach(function (contInfo) {
  return contactInfo.push(`${contInfo.first_name} ${contInfo.email}`);
});
...
const lowPop =  zooAnimals.filter(function(itemsLowPop) {
  return itemsLowPop.population < 5;
});
...
*/
const populationTotal = zooAnimals.reduce(function(accumulator, itemTotalPop) {
  return accumulator + itemTotalPop.population;
  } ,0);
